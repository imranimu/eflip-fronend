...
$q = 'DELETE FROM suppression_list WHERE app = '.$app;
...
{
	echo false;
	error_log("[Unable to delete all email addresses in suppression_list]".mysqli_error($mysqli).': in '.__FILE__.' on line '.__LINE__);
	exit;
}
