...
<div class="row-fluid">
    ...
    <div class="span5">
	    ...
	    <form action="<?php echo get_app_info('path')?>/includes/subscribers/import-update.php" method="POST" accept-charset="utf-8" class="form-vertical" enctype="multipart/form-data" id="import-update-form">
        	...
        	<ul>
        		<li><?php echo _('Format your CSV the same way as the example below');?> <a href="<?php echo get_app_info('path');?>/includes/subscribers/sample-csv.php?l=<?php echo $lid;?>" title="" style="text-decoration:underline;">(<?php echo _('download sample CSV file');?>)</a></li>
