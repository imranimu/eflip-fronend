...
@section('content')
      ...
      <form action="{{ route('admin.pages.store') }}" method="post" enctype="multipart/form-data">
			...
			<div class="row">
				<div class="col-md-12">
					<div class="form-group">
						...
						<textarea rows="5" name="description" id="editor" class="form-control {{ $errors->has('description') ? ' is-invalid' : '' }}" style="height:100px;" placeholder="Describe the page with stylish document editor. this design will be same to same in the public page."required>{{old('description')}}</textarea>
		...
		<button type="submit" class="btn_1 medium">Add Page</button>
    </form>
